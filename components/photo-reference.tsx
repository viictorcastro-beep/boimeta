...
export function PhotoReferenceNotes({ report = false }: { report?: boolean }) {
  return <details open={report || undefined} className="rounded-xl border p-4 text-sm">
    ...
    <div className="mt-3 space-y-3">
      <p>A base inicial usa os parâmetros legíveis das fotos e complementos identificados abaixo. Os controles mostram os valores atuais, que podem ter sido alterados. A recria com venda do magro e as culturas agrícolas usam bases separadas; não são cenários comprovados por estas fotos.</p>
