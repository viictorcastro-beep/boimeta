...
export function validateScenario<T>(document: unknown, template: T): T {
  ...
  if (model !== undefined && (typeof model !== 'string' || !['2026-09-06.1', '2026-09-06.2', '2026-09-06.3', '2026-09-06.4', '2026-09-07.1', '2026-09-07.2', '2026-09-07.3', '2026-09-07.4', '2026-09-07.5'].includes(model)))
